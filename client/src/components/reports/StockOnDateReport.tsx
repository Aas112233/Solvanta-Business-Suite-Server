...
type FilterPanel = 'date' | 'branch' | 'item' | 'columns' | null;
type ColumnKey =
    | 'itemCode'
    | 'itemName'
    | 'itemGroup'
            ...
            <div className="rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-50 via-indigo-50 to-white p-5 shadow-sm">
                <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
                    <div className="flex items-center gap-3">
                        <div className="rounded-xl bg-blue-600 p-2.5 text-white"><PackageSearch size={18} /></div>
                        <div>
                            <h2 className="text-lg font-black text-slate-900">Stock on Date Report</h2>
                            <p className="text-sm text-slate-600">Historical stock snapshot for a selected date with item filters.</p>
                        </div>
                    </div>
